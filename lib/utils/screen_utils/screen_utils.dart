...
class ScreenUtil {
  ...
  /// Số lượng pixel phông chữ trên mỗi pixel lôgic, tỷ lệ của phông chữ
  ...
  /// Tỷ lệ giữa kích thước thực tế với thiết kế giao diện người dùng
  /// The ratio of actual width to UI design
  double get scaleWidth => screenWidth / _uiSize.width;

  /// Tỷ lệ chiều cao thực tế so với thiết kế giao diện người dùng
